<section>
    <header>
        ...
        <p class="mt-1 text-sm text-[#767676]">
            Mantenha sua senha atualizada para proteger sua conta.
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="flex items-center gap-4">
            <button type="submit" class="rounded bg-[#D42B2B] px-5 py-2.5 text-sm font-black text-white transition hover:bg-[#B02020]">
                Atualizar senha
            </button>
